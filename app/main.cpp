...
//          _                             _     _        __       
//         / \   ___ ___ ___  _   _ _ __ | |_  (_)_ __  / _| ___  
//        / _ \ / __/ __/ _ \| | | | '_ \| __| | | '_ \| |_ / _ \ 
//       / ___ \ (_| (_| (_) | |_| | | | | |_  | | | | |  _| (_) |
//      /_/   \_\___\___\___/ \__,_|_| |_|\__| |_|_| |_|_|  \___/ 
                                                           
        {
            ImGui::Begin("Account info");
            if (!dg.logged_in) ImGui::BeginDisabled();
            ...
            if (!dg.logged_in) ImGui::EndDisabled();
            ImGui::End();
        }
//       ____            _    __       _ _       
...

        {
            ...
            if (dg.portfolio.count == 0) {
                ...
                for (auto i = 0; i < dg.portfolio.count; i ++) {
                    ...
                    if (show_non_zero_only && position.size <= 0) continue;
...
//      |_|   |_|  |_|\___\___|
                        
        {
...

            {
                ...
                if (history.chart.n_points > 0) {
                    ...
                    for (size_t i = 0; i < history.chart.n_points; ++i) {
                        if (history.chart.prices[i] < min_val) min_val = history.chart.prices[i];
            ...
            // ImGui::PlotLines("Lines", values, n_values, 0.0, NULL, min, max, ImVec2(0, 80.0f));
